...
export default function DataLine(props) {
  ...
  return (
    <Box className={`${classes.bannerBox} wow bounceInUp`} data-wow-duration="0.5s" data-wow-delay="0.5s">
       <img
      ...
      <Box className={classes.counter}>
        ...
        <img className={classes.totalValuesWrap} src="/images/home/total-values-border.svg" alt="Total values border" loading="lazy" />
         <Box className={classes.DataBox}>
           <Box className={`${classes.innerData} wow slideInRight`} data-wow-duration="0.1s" data-wow-delay="0.1s">
           ...
           <Box className={`${classes.innerData} wow slideInRight`} data-wow-duration="0.2s" data-wow-delay="0.2s">
           <Typography variant="h2">
           Total Value Locked
          </Typography>
           <Typography variant="h4">
           ...
           <Box className={`${classes.innerData} wow slideInRight`} data-wow-duration="0.3s" data-wow-delay="0.3s">
           <Typography variant="h2">
           Current APY
          </Typography>
           <Typography variant="h4">
