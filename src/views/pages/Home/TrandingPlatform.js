				...
				<Box className={classes.counter}>
					<Box className={classes.textbox} mb={4}>
						<Typography
							...
							data-wow-delay="0.3s"
						>
							Stake and earn passive income & rewards with EZE!
						</Typography>
					</Box>
					<img
					...
					<Grid container spacing={6} align="center">
						...
						>
							...
							<Typography variant="body2">
								Staking generates passive income from compound interests,
								steadily increasing your EZE tokens in the long haul. Consider
								it a safe haven for capital in the cryptocurrency space.
							</Typography>
						...
						>
							...
							<Typography variant="body2">
								Whilst staking EZE gets minted and evenly distributed as a
								staking reward. This allows your investments to work for you
								passively. Although when more EZE is staked it reduces
							</Typography>
							{/* <Button variant="contained" color="primary" size="large">- Read More</Button> */}
						</Grid>
						<Grid
						...
						>
							...
							<Typography variant="body2">
								...
								(Limited time only, gift to our early supporters!
							</Typography>
							{/* <Button variant="contained" color="primary" size="large">- Read More</Button> */}
						</Grid>
					</Grid>
