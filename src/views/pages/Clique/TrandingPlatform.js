				...
				<Box className={classes.counter}>
					<Box className={classes.textbox} mb={6}>
						...
						<Typography variant="h6">
							Unlike the stock market where passive investors can select managed
							funds to invest in, Crypto markets have yet to devise a way for
							investors to find market-makers or managed funds with a proven
							track record.
						</Typography>
					</Box>
					<img
					...
					<Grid container spacing={2} align="center">
						...
						<Grid item xs={6} sm={3}>
							...
							<Typography variant="body2">Secure Contract</Typography>
						</Grid>
					</Grid>
				</Box>
			</Container>
