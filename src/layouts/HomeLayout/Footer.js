...
const useStyles = makeStyles((theme) => ({
  ...
  footerSection: {
    ...
    "& .MuiOutlinedInput-adornedEnd": {
      paddingRight: "0px", height: "55px", background: "#1A1B1D", borderRadius: "7px", fontSize: "14px",
      border: "0.1px solid #020202",
    },
    '& .MuiButton-containedSizeSmall': {
      height: "53px",
      fontSize: "14px", borderRadius: "9px 7px 7px 9px",
    },
    "& .footer_text": {
      "& a": {
        color: theme.palette.primary.dark,
  ...
  return (
    <Box className={classes.footerSection}>
        ...
        <Grid container spacing={1} >
          ...
          <Grid item xs={6} sm={4} md={2} align="left">
            <Box class=" col-lg-4 col-md-4 col-sm-6 col-12">
              ...
              <ul class="footer_text">
                ...
                <li>
                  <Link href="">EZE CLique</Link>
                </li>
                <li>
                  <Link href="">EZE Live</Link>
                </li>
          ...
          <Grid item xs={12} sm={6} md={4} align="left">
            <Box>
              ...
              <Typography variant="body2">Get the latest news and updates</Typography>
              <TextField
                style={{ marginTop: "2px" }}
                id="outlined-basic"
      ...
      <Box className={classes.lowerFooter}>
        <Typography variant="h6">© 2021 EZE Technologies, INC. All Rights Reserved</Typography>
      </Box>
    </Box>
  );
}
